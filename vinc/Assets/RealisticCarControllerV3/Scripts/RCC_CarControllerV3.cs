...
//		GetComponentInChildren<WheelCollider>().ConfigureVehicleSubsteps(10f, 1, 1);
	...
	void SoundsInitialize (){
		...
		case AudioType.OneSource:
			...
			engineSoundHigh = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High AudioSource", 5, 15, 0, engineClipHigh, true, true, false);

			if (autoCreateEngineOffSounds) {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High Off AudioSource", 5, 15, 0, engineClipHigh, true, true, false);

				RCC_CreateAudioSource.NewLowPassFilter (engineSoundHighOff, 3000f);

			} else {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High Off AudioSource", 5, 15, 0, engineClipHighOff, true, true, false);
		...
		case AudioType.ThreeSource:
			...
			engineSoundHigh = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High AudioSource", 5, 15, 0, engineClipHigh, true, true, false);
			engineSoundMed = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Medium AudioSource", 5, 15, 0, engineClipMed, true, true, false);
			engineSoundLow = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Low AudioSource", 5, 25, 0, engineClipLow, true, true, false);

			if (autoCreateEngineOffSounds) {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High Off AudioSource", 5, 15, 0, engineClipHigh, true, true, false);
				engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Medium Off AudioSource", 5, 15, 0, engineClipMed, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLow, true, true, false);
				...
				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound High Off AudioSource", 5, 15, 0, engineClipHighOff, true, true, false);
				engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Medium Off AudioSource", 5, 15, 0, engineClipMedOff, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLowOff, true, true, false);
		...
		engineSoundIdle = RCC_CreateAudioSource.NewAudioSource(gameObject, "Engine Sound Idle AudioSource", 5, 6, 0, engineClipIdle, true, true, false);
