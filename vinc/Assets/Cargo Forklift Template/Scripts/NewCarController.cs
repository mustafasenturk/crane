...
using UnityEngine;
    ...
    {
        public static NewCarController Instance { get; private set; }
        ...
        m_SteerAngle = GetComponent<SteeringWheel>().GetClampedValue();
        m_SteerAngle = m_SteerAngle * m_MaximumSteerAngle;
